    ...
    try {
        ...
        return NextResponse.json({
            ...
            settings: {
                ...
                homepage: {
                    hero_badge: map.home_hero_badge,
                    hero_title: map.home_hero_title,
                    hero_subtitle: map.home_hero_subtitle,
                    hero_image_url: map.home_hero_image_url,
                    categories_title: map.home_categories_title,
                    categories_subtitle: map.home_categories_subtitle,
                    categories_cta: map.home_categories_cta,
                    best_sellers_title: map.home_best_sellers_title,
                },
                shipping_fees: {
